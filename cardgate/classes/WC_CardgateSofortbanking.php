...
class WC_CardgateSofortbanking extends CGP_Common_Gateway {
     ...
     * @const ID string
     */
    const ID = 'cardgatesofortbanking';
    const MethodTitle = 'Cardgate SofortBanking';
    const AdminTitle = 'Cardgate SofortBanking';
    const PaymentName = 'Cardgate - Sofortbanking';
    const Company = 'Cardgate';
    const HasFields = false;   //extra field for bank data
    const PaymentMethod = 'sofortbanking';
