...
/**
 * Onlineueberweisen payment method integration
 */
final class OnlineueberweisenCardgate extends AbstractPaymentMethodType {
	 ...
	 * @var string
	 */
	protected $name = 'cardgateonlineueberweisen';
	...
	public function get_payment_method_script_handles() {
		...
		wp_register_script(
			'wc_payment_method_cardgateonlineueberweisen',
			$url . 'build/index.js',
			array(),
			'1020349.' . wp_rand( 0, 9999 ),
			true
		);
		return array( 'wc_payment_method_cardgateonlineueberweisen' );
	}
	...
	public function get_payment_method_data() {
		return array(
			...
			'icon'         => $this->iconpath . 'onlineueberweisen.svg',
	...
	private function get_settings() {
		$settings              = get_option( 'woocommerce_cardgateonlineueberweisen_settings', array() );
